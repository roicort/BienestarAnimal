...
from .serializers import AnimalCategoriaSerializer, AnimalInclusionSerializer, \
    ...
    AnimalFavoritoSerializer, AnimalFavoritoCreateSerializer, MiPostulacionAdopcionListSerializer
...
class AnimalViewSet(viewsets.ModelViewSet):
    ...
    ordering_fields = ['fecha_publicacion_inicio','edad_minima', 'salario_minimo']
